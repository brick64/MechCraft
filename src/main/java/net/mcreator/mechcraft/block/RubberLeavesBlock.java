...
public class RubberLeavesBlock extends MechcraftModElements.ModElement {
	@ObjectHolder("mechcraft:rubber_leaves")
	public static final Block block = null;
	public RubberLeavesBlock(MechcraftModElements instance) {
		super(instance, 3);
	}
