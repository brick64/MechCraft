...
package net.mcreator.mechcraft.world.structure;
...
public class RubberStructure extends MechcraftModElements.ModElement {
			...
			if ((random.nextInt(1000000) + 1) <= 300000) {
				...
				for (int a = 0; a < count; a++) {
					...
					Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
							.getTemplateDefaulted(new ResourceLocation("mechcraft", "1"));
					if (template == null)
						return false;
	...
	public RubberStructure(MechcraftModElements instance) {
		super(instance, 4);
	...
	public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
		event.getRegistry().register(feature.setRegistryName("rubber"));
	}
